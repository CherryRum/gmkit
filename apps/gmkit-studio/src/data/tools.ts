...
export const tools: ToolDefinition[] = [
  {
    ...
    tabs: [
      ...
      },
      {
        ...
        fields: [
          { name: 'format', label: '输出格式', kind: 'select', options: ['Hex', 'Base64'] },
          { name: 'publicKey', label: '公钥压缩输入', kind: 'textarea', placeholder: '需要压缩时粘贴非压缩公钥 Hex' },
        ],
    ...
    tabs: [
      {
        ...
        fields: [
          ...
          { name: 'output', label: '输出/密文格式', kind: 'select', options: ['Hex', 'Base64'] },
